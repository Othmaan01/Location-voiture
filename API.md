...
| GET     | `/v1/me/notifications`                            | connecté           | centre de notifications : 60 derniers jours (100 max) et nombre de non lues, hors messages (comptés sur la bulle Messages)                                                                                                                          |
| POST    | `/v1/me/notifications/read`                       | connecté           | marque lu (`{ ids? }`, sinon tout)                                                                                                                                                                                                                  |
...
| GET / PUT / DELETE    | `/v1/me/favorites[/:vehicleId]`                                                                                       | connecté | favoris (véhicules publiés) avec `groupId`, et groupes de favoris ; `PUT` accepte `{ groupId }` (`null` = sans groupe)              |
| POST / PATCH / DELETE | `/v1/me/favorite-groups[/:id]`                                                                                        | connecté | groupes de favoris (« Mariage Mejdi 2027 ») : nom unique par utilisateur, 40 caractères ; supprimer un groupe garde ses favoris     |
