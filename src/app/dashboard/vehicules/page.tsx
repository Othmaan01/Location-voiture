    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            {limit !== null ? ` sur ${limit} autorises (palier ${plan.name})` : " — palier illimite"}
          </p>
        </div>
      ...
      {vehicles.length === 0 ? (
        <EmptyState
          ...
          action={<ButtonLink href="/dashboard/vehicules/nouveau" size="sm">Ajouter un vehicule</ButtonLink>}
        />
      ) : (
            ...
            <div key={vehicle.id} className="flex flex-wrap items-center gap-4 p-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate font-medium text-ink-900">
                  ...
                  {vehicle.version ? <span className="text-ink-400"> {vehicle.version}</span> : null}
                </p>
