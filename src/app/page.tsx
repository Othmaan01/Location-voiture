        ...
        <div className="container-page grid items-center gap-12 py-16 lg:grid-cols-[1.05fr_1fr] lg:py-24">
          <div className="space-y-7">
            ...
            <p className="max-w-xl text-lg text-ink-600">
              Comparez les agences pres de chez vous, consultez les vehicules disponibles avec
              leurs prix et leurs options, puis contactez le loueur en direct. Aucune commission,
              aucun intermediaire.
            </p>
