      ...
      <div className="hero-glow border-b border-ink-100">
        <div className="container-page py-12">
          <nav className="mb-4 flex items-center gap-1.5 text-xs text-muted-foreground">
            ...
            <span>/</span>
            <Link href="/villes" className="hover:text-ink-900">
              Villes
            </Link>
            <span>/</span>
          ...
          <p className="mt-4 max-w-2xl text-ink-600">
            {coverage && coverage.agency_count > 0 ? (
              <>
                ...
                {coverage.min_price
                  ? ` a partir de ${formatPrice(coverage.min_price)} par jour`
                  : ""}
                . Comparez les offres et contactez directement le loueur : aucune commission
                n&apos;est prelevee sur votre location.
              </>
            ) : (
              <>
                Aucune agence n&apos;est encore referencee a {city.name}. Vous etes loueur dans
                cette ville ? Referencez votre agence gratuitement et soyez le premier visible ici.
              </>
            )}
          </p>
      ...
      <div className="container-page py-12">
        {results.items.length > 0 ? (
          ...
          <EmptyState
            ...
            action={
              <ButtonLink href="/villes" variant="outline" size="sm">
