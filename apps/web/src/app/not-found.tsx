  ...
  return (
    <div className="container-page flex min-h-[60dvh] flex-col items-center justify-center gap-5 text-center">
      ...
      <p className="max-w-md text-muted-foreground">
        Le vehicule ou l&apos;agence que vous cherchez a peut-etre ete retire. Explorez la carte
        pour trouver une alternative pres de chez vous.
      </p>
      <div className="flex flex-wrap justify-center gap-3">
        <ButtonLink href="/recherche">Explorer la carte</ButtonLink>
