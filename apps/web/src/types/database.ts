...
export interface Database {
  public: {
    Tables: {
      ...
      cities: {
        Row: Row<City>;
        Insert: Insert<City, "name" | "slug" | "latitude" | "longitude">;
        Update: Partial<City>;
      };
      agencies: {
        Row: Row<Agency>;
        Insert: Insert<Agency, "owner_id" | "name" | "slug">;
        Update: Partial<Agency>;
      };
      vehicles: {
        Row: Row<Vehicle>;
        Insert: Insert<Vehicle, "agency_id" | "brand" | "model" | "price_per_day">;
        Update: Partial<Vehicle>;
      };
      leads: {
        Row: Row<Lead>;
        Insert: Insert<Lead, "agency_id" | "first_name" | "email">;
        Update: Partial<Lead>;
      };
      reviews: {
        Row: Row<Review>;
        Insert: Insert<Review, "agency_id" | "author_id" | "rating">;
        Update: Partial<Review>;
      };
      subscriptions: {
        Row: Row<Subscription>;
        Insert: Insert<Subscription, "agency_id">;
