        ...
        <CardContent className="space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Field
              label="Prix / jour (€)"
              required
              error={state.errors?.pricePerDay}
              htmlFor="pricePerDay"
            >
              <Input
                id="pricePerDay"
            ...
            <Field label="Prix / semaine (€)" htmlFor="pricePerWeek">
              <Input
                ...
                min={0}
                step="0.01"
                defaultValue={vehicle?.price_per_week ?? ""}
              />
            </Field>
            <Field label="Prix / mois (€)" htmlFor="pricePerMonth">
              <Input
                ...
                min={0}
                step="0.01"
                defaultValue={vehicle?.price_per_month ?? ""}
              />
            </Field>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Field label="Caution (€)" htmlFor="depositAmount">
              <Input
                ...
                min={0}
                step="1"
                defaultValue={vehicle?.deposit_amount ?? ""}
              />
            </Field>
            <Field label="Km inclus / jour" htmlFor="mileageIncludedDay">
              <Input
                id="mileageIncludedDay"
                name="mileageIncludedDay"
                type="number"
                min={0}
                defaultValue={vehicle?.mileage_included_day ?? ""}
              />
            </Field>
            <Field label="Prix du km sup. (€)" htmlFor="extraKmPrice">
              <Input
                ...
                min={0}
                step="0.01"
                defaultValue={vehicle?.extra_km_price ?? ""}
              />
            </Field>
          </div>
        </CardContent>
          ...
          <label className="flex items-center gap-2.5 text-sm text-ink-700">
            ...
            {!allowFeatured ? (
              <Link
                ...
                className="text-xs font-medium text-amber-brand-dark underline"
              >
                (palier Pro requis)
              </Link>
            ) : null}
